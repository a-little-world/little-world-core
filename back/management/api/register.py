...
class Register(APIView):
    ...
    def post(self, request) -> Optional[Response]:
        ...
        usr = controller.create_user(**{k: getattr(registration_data, k) for k in registration_data.__annotations__}, send_verification_mail=True, check_prematching_invitations=True)
