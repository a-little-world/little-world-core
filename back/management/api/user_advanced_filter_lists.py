...
USER_JOURNEY_FILTER_LISTS = [
    ...
    FilterListEntry("community__learners_with_a1a2", "Learners with A1/A2", community__learners_with_a1a2),
    FilterListEntry("community__learners_better_than_a1a2", "Learners with at least B1", community__learners_better_than_a1a2),
