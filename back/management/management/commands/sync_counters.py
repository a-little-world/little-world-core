...
class Command(BaseCommand):
    def handle(self, *args, **options):
        ...
        volunteers_impossible_lang_level = User.objects.filter(
            ...
            | Q(
                profile__lang_skill__contains=[
                    {"lang": Profile.LanguageChoices.GERMAN, "level": Profile.LanguageSkillChoices.LEVEL_1}
                ]
            ),
        ...
        for vol in volunteers_impossible_lang_level:
            ...
            vol.profile.lang_skill = [
                {"lang": Profile.LanguageChoices.GERMAN, "level": Profile.LanguageSkillChoices.LEVEL_2}
            ]
            vol.profile.save()
