    ...
    def handle_bulk_emails(self, users):
        ...
        if user_input == "Y":
            ...
            for i, user in enumerate(users, 1):
                ...
                send_email_background.delay(template_name="new-match-engage", user_id=user.id)
    ...
    def handle_test_email(self):
        ...
        if user_input == "Y":
            ...
            try:
                ...
                send_email_background.delay(template_name="new-match-engage", user_id=test_user.id)
