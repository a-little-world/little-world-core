...
class ProfileSerializer(serializers.ModelSerializer):
    ...
    groups = serializers.MultipleChoiceField(choices=Profile.TargetGroupChoices2.choices)
...
class MinimalProfileSerializer(serializers.ModelSerializer):
    class Meta:
        model = Profile
        fields = ["first_name", "second_name", "target_group", "lang_skill", "interests", "image_type", "avatar_config", "image", "description", "user_type", "groups"]
