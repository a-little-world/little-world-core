...
class State(models.Model):
    ...
    attended_auto_email_u071_send = models.BooleanField(default=False, null=False, blank=False)
    attended_auto_email_u071_send_at = models.DateTimeField(default=None, null=True, blank=True)
    not_attended_auto_email_u051_send = models.BooleanField(default=False, null=False, blank=False)
    not_attended_auto_email_u051_send_at = models.DateTimeField(default=None, null=True, blank=True)
