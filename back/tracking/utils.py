...
def _ip_meta(request):
    ...
    return {"IP": client_ip, "public": is_routable}
...
def inline_track_event(
    ...
    **kwargs,
    ...
    _user = None
    if event_type == Event.EventTypeChoices.MISC or event_type == Event.EventTypeChoices.REQUEST:
        ...
        for a in args:
            ...
            if "request" in str_type:
                ...
                try:
                    ...
                    metadata["msg"].append(_("request.data 2 not existing"))
