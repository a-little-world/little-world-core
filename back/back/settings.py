...
DOCS_BUILD = os.environ.get("DJ_DOCS_BUILD", "false").lower() in ("true", "1", "t")

USE_AUTO_RELOAD = os.environ.get("DJ_USE_AUTO_RELOAD", "false").lower() in ("true", "1", "t")
...
PREMATCHING_CALL_JOIN_LINK = os.environ.get("DJ_PREMATCHING_CALL_JOIN_LINK", "")
...
META_CAPI_ENABLED = os.environ.get("DJ_META_CAPI_ENABLED", "false").lower() in ("true", "1", "t")
META_PIXEL_ID = os.environ.get("DJ_META_PIXEL_ID", "")
META_CAPI_ACCESS_TOKEN = os.environ.get("DJ_META_CAPI_ACCESS_TOKEN", "")
META_CAPI_API_VERSION = os.environ.get("META_CAPI_API_VERSION", "v20.0")
META_CAPI_TEST_EVENT_CODE = os.environ.get("DJ_META_CAPI_TEST_EVENT_CODE", "")
META_CAPI_TIMEOUT_SECONDS = int(os.environ.get("META_CAPI_TIMEOUT_SECONDS", "5"))
META_CAPI_MAX_RETRIES = int(os.environ.get("DJ_META_CAPI_MAX_RETRIES", "5"))
META_CAPI_EVENT_LOG_RETENTION_DAYS = int(os.environ.get("DJ_META_CAPI_EVENT_LOG_RETENTION_DAYS", "180"))
...
DEVELOPMENT_DISABLE_PLAY_INTEGRITY = os.environ.get("DJ_DEVELOPMENT_DISABLE_PLAY_INTEGRITY", "0").lower() in (
    "true",
    "1",
    "t",
)
...
if USE_MINIO:
    ...
    STATICFILES_DIRS = [os.path.join(BASE_DIR, "emails/static/")]
...
LOCALE_PATHS = [os.path.join(BASE_DIR, "management/locale/"), os.path.join(BASE_DIR, "management/")]
...
DATABASES = (
    ...
    if ((IS_DEV and ("DJ_DATABASE_ENGINE" not in os.environ)) or USE_SQLITE)
        ...
        "default": {
            "ENGINE": "django.db.backends.{}".format(os.environ["DJ_DATABASE_ENGINE"]),
...
JAZZMIN_SETTINGS = {
    ...
    "user_avatar": None,
    "topmenu_links": [
        {"name": "Home", "url": "/app", "permissions": ["auth.view_user"]},
        {"name": "Repo", "url": "https://github.com/a-little-world/little-world-backend", "new_window": True},
        {"name": "Matching Pannel", "url": "/admin_panel", "new_window": True},
        {"name": "Stats Pannel", "url": "/stats/graph/any", "new_window": True},
        {"name": "DB shema", "url": "/db", "new_window": True},
        {"name": "Admin Chat", "url": "/admin_chat", "new_window": True},
        {"name": "Docs", "url": "/static/docs", "new_window": True},
        {"name": "API", "url": "/api/schema/swagger-ui/", "new_window": True},
        {"name": "Emails", "url": "/emails/welcome", "new_window": True},
        {"event": "tracking"},
    ],
    "usermenu_links": [
        {"name": "Matching Pannel", "url": "/admin_panel", "new_window": True},
        {"name": "AdminChat", "url": f"{BASE_URL}/admin_chat", "new_window": True},
        {"name": "Home", "url": "/app", "permissions": ["auth.view_user"]},
        {"name": "Repo", "url": "https://github.com/a-little-world/little-world-backend", "new_window": True},
        {"name": "DB shema", "url": "/db", "new_window": True},
        {"name": "Admin Chat", "url": "/admin_chat", "new_window": True},
...
ENABLE_AUTO_EMAILS__U051_U052 = bool_env("DJ_ENABLE_AUTO_EMAILS__U051_U052", "false")
EMULATE_AUTO_EMAILS__U051_U052 = bool_env("DJ_EMULATE_AUTO_EMAILS__U051_U052", "true")

ENABLE_AUTO_EMAILS__FM021_FM022 = bool_env("DJ_ENABLE_AUTO_EMAILS__FM021_FM022", "false")
EMULATE_AUTO_EMAILS__FM021_FM022 = bool_env("DJ_EMULATE_AUTO_EMAILS__FM021_FM022", "true")

ENABLE_AUTO_EMAILS__M051 = bool_env("DJ_ENABLE_AUTO_EMAILS__M051", "false")
EMULATE_AUTO_EMAILS__M051 = bool_env("DJ_EMULATE_AUTO_EMAILS__M051", "true")
...
ENABLE_AUTO_EMAIL_LOGS = (
    ...
    or ENABLE_AUTO_EMAILS__U051_U052
    or ENABLE_AUTO_EMAILS__FM021_FM022
    or ENABLE_AUTO_EMAILS__M051
)

ENABLE_DAILY_SMS_REPORT = bool_env("DJ_ENABLE_DAILY_SMS_REPORT", "false")

# User Journey Related Settings
EXTRA_FORCE_MATCH_ELIGIBLE_COMPANIES = string_list_env("DJ_EXTRA_FORCE_MATCH_ELIGIBLE_COMPANIES", ["odoo-eip-fms"])
FORCE_MATCH_ELIGIBLE_COMPANIES = ["lingoda"] + EXTRA_FORCE_MATCH_ELIGIBLE_COMPANIES
EXTRA_CUSTOM_ONBOARDING_COMPANIES = string_list_env("DJ_EXTRA_CUSTOM_ONBOARDING_COMPANIES", ["odoo-eip-fms"])
CUSTOM_ONBOARDING_COMPANIES = [
    "lingoda",
    "fh-aachen",
    "self-organized-kaiserslautern",
] + EXTRA_CUSTOM_ONBOARDING_COMPANIES
EXTRA_SKIP_EMAIL_VERIFICATION_COMPANIES = string_list_env("DJ_EXTRA_SKIP_EMAIL_VERIFICATION_COMPANIES", [])
SKIP_EMAIL_VERIFICATION_COMPANIES = [] + EXTRA_SKIP_EMAIL_VERIFICATION_COMPANIES

# Match Priority Settings
EXTRA_MATCH_PRIORITY_COMPANIES = string_list_env("DJ_EXTRA_MATCH_PRIORITY_COMPANIES", ["odoo-eip-fms"])
MATCH_PRIORITY_COMPANIES = ["accenture", "generali", "lingoda", "fh-aachen"] + EXTRA_MATCH_PRIORITY_COMPANIES

# Scoring Related Settings
SCORES_DISABLED_TIME_OVERLAP = ["fh-aachen"]
