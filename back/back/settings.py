...
META_CAPI_ENABLED = os.environ.get("META_CAPI_ENABLED", "false").lower() in ("true", "1", "t")
...
META_CAPI_MAX_RETRIES = int(os.environ.get("META_CAPI_MAX_RETRIES", "5"))
META_CAPI_EVENT_LOG_RETENTION_DAYS = int(os.environ.get("META_CAPI_EVENT_LOG_RETENTION_DAYS", "180"))
