...
var config = function (env) {
  var publicPath = '/static/dist/user_form/';
  ...
  var outputPath = '../back/static/dist/user_form';
  var entry = './apps/user_form';
  ...
  return {
    ...
    resolve: {
      alias: {
        '@': path.resolve(__dirname, 'apps/user_form/src/'),
